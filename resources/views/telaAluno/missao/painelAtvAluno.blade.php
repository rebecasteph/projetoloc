...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="nav-atv" role="tabpanel" aria-labelledby="nav-atv-tab">.atv.</div>
  <div class="tab-pane fade" id="nav-resp" role="tabpanel" aria-labelledby="nav-resp-tab">..resp.</div>
  <div class="tab-pane fade" id="nav-comm" role="tabpanel" aria-labelledby="nav-comm-tab">..com000000000000ents.</div>
</div>